...
**How it works:**
- Click and hold on any node you want to move
...
> [!TIP]
> Watch the visual feedback carefully - blue dashed outlines show all possible drop zones, while green highlights indicate where you'll drop if you release. If you don't see any feedback, the target is not compatible with what you're dragging.
